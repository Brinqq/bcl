...
// #include "bk/assert.h"
// #include "bk/containers/freelist.h"
//
// #include <type_traits>
// #include <limits>
// #include <algorithm>
...
//   static _bkconstexpr11 size_t start_capacity = _Start_capacity;
//   static _bkconstexpr11 bool gen = _Generation;
//   static _bkconstexpr11 size_t max_size = static_cast<size_t>(std::numeric_limits<_Key_type>::max());
//   static _bkconstexpr11 bool movable = std::is_move_assignable_v<_Type> && std::is_move_constructible_v<_Type>;
//   static _bkconstexpr11 bool copyable = std::is_copy_constructible_v<_Type> && std::is_copy_assignable_v<_Type>;
//   static _bkconstexpr11 bool assignable = std::is_assignable_v<_Type, _Type> || std::is_trivially_assignable_v<_Type, _Type>;
//   static _bkconstexpr11 bool memcpyable = std::is_trivially_copyable_v<_Type>;
//
...
// private:
//
//   static _bkconstexpr11 _freelist_traits flt{.fixed = false, .force_heap = true};
//   static _bkconstexpr11 uint8_t growth_rate = 4.0f;
//
//   struct handle_type{
